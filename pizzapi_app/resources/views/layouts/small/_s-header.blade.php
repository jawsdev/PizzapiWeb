<div class="row no_bottom_margin pizzapi-red">
    ...
    <div class="col s4">
        <div class="header-logo aligner">
            <div class="aligner-item--fixed"><a href="{{ route('pages.main') }}"><img class="logo-image fadeIn"
                                                                                      src="{{ URL::to('/') }}/img/logo.png"></a>
            </div>
        </div>
    </div>
    <div class="col s4">
...
<div id="myNav" class="overlay" style="height: 0%;">
    <div class="overlay-content">
        <div class="row">
            <div class="col s5">
                @if(Auth::check())
                    <h6 class="s_nav_name">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h6>
                    <h6 class="s_nav_email">{{ Auth::user()->email }}</h6>
            ...
            <div class="col s6">
                <div class="row">
                    ...
                    <div class="col s3">
                        @if(Session::has('cart'))
                            <a href="{{ route('product.shoppingCart') }}"><h6 style="font-size: 1.2rem;"
                                                                              class="valign">{{ Session::has('cart') ? Session::get('cart')->totalQty : '' }}</h6>
                            </a>
                        @else
